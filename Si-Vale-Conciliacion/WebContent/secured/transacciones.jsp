													...
													<td colspan="6">
														<div class="form-group">
															...
															<input type="text" class="form-control"
																id="facturaComment1" placeholder="Ingresa Comentarios" />
														</div>
													</td>
												</tr>
											</tbody>
												...
												<tr style="height: 75px;">
													...
													<td style="width: 200px;"><span
														class="btn btn-default btn-file"> <span
															...
															aria-hidden="true"> Explorar <input type="file">
														</span>
													</span></td>
												</tr>
												<tr style="height: 75px;">
												...
												<tr style="height: 75px;">
													...
													<td colspan="6">
														<div class="form-group">
															<label class="sr-only" for="comment">Comentario:</label>
															<input type="text" class="form-control"
																id="ticketComment" placeholder="Ingresa Comentarios" />
														</div>
													</td>
												</tr>
											</tbody>
		...
		<div id="footer">
			<div class="container">
				<p class="text-muted credit">
					Si Vale <a href="http://latbc.com">Latbc 2015</a> Todos los
					derechos reservados.
				</p>
			</div>
		</div>
		...
		<script>
			function propinaFunction(montoId, propinaId, totalId, alertaId) {
				...
				if (parseFloat(propina) <= parseFloat(maximaProp)) {
					...
					document.getElementById("vincularButtonIdFac").prop(
							"disabled", false);
				} else {
