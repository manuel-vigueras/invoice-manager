							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<div class="row">
										...
										<!-- Table Header Left *** ESTATUS FILTRO ***
                        <div class="col-md-2">
                          ...
                          <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="movimientos.html">Todas</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="conciliadas.html">Conciliadas</a></li>
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="no_conciliadas.html">No Conciliadas</a></li>    
                          </ul>

                        </div>End of Table Header Left -->
										...
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													...
													<td>23640015 38164532</td>
													<td>4367124</td>
													<td>02/04/2015</td>
													<td>CAPITAL JEANS SA CV</td>
													<td><p class="text-right">$ 756.00</p></td>
													<td><p class="text-right">$ 20,000.00</p></td>
													<td><p class="text-left">MONTERREY</p></td>
													...
													<td><span class="label label-success"
														href="pdf/file1.pdf">Conciliada</span></td>
												</tr>
												<tr>
													<td>Alfonso López Alcántara</td>
													<td>23640015 38164532</td>
													...
													<td>04/04/2015</td>
													<td>POLMAL SA CV</td>
													<td><p class="text-right">$1,345.00</p></td>
													<td><p class="text-right">$18,655.00</p></td>
													<td><p class="text-left">MONTERREY</p></td>
													<td><a data-toggle="modal"
														data-target="#modalDetalleFactura2"> <img
															src="img/xml.png" alt="XML"
															style="width: 20px; height: 20px">
													</a></td>
													<td><span class="label label-success">Conciliada</span></td>
												</tr>
												<tr>
													<td>David Gutiérrez Hernández</td>
													<td>23640015 38876234</td>
													<td>7647903</td>
													<td>05/04/2015</td>
													<td>7 ELEVEN MÉXICO SA CV</td>
													<td><p class="text-right">$58.00</p></td>
													<td><p class="text-right">$18,597.00</p></td>
													<td><p class="text-left">MÉRIDA</p></td>
													<td><a data-toggle="modal"
												...
												<tr>
													...
													<td>5846902</td>
													<td>11/04/2015</td>
													<td>CORPORATIVO NUHAIR SC</td>
													<td><p class="text-right">$533.00</p></td>
													<td><p class="text-right">$18,064.00</p></td>
													<td><p class="text-left">MÉRIDA</p></td>
													<td><a type="button" class="btn btn-default btn-xs"
														data-toggle="modal"
														data-target="#modalComprobanteSugerido"> <span
															class="glyphicon glyphicon-plus" aria-hidden="true"></span>
													</a></td>
													<td><span class="label label-danger">No
															conciliada</span></td>
												</tr>
												<tr>
													<td>Antonio Cortés Zamora</td>
													<td>23640015 38167285</td>
													<td>8649501</td>
													<td>13/04/2015</td>
													<td>RETIRO DE EFECTIVO</td>
													<td><p class="text-right">$1,500.00</p></td>
													<td><p class="text-right">$16,564.00</p></td>
													<td><p class="text-left">VERACRUZ</p></td>
													<td><a data-toggle="modal"
														data-target="#modalDetalleFactura5A"> <img
															src="img/xml.png" alt="XML"
															style="width: 20px; height: 20px">
													</a> <a data-toggle="modal"
														data-target="#modalDetalleFactura5B"> <img
															src="img/xml.png" alt="XML"
															style="width: 20px; height: 20px">
													</a></td>
													<td><span class="label label-success">Conciliada</span></td>
												...
												<tr>
													...
													<td>23640015 38145683</td>
													<td>7549445</td>
													<td>19/04/2015</td>
													<td>RETIRO DE EFECTIVO</td>
													<td><p class="text-right">$2,000.00</p></td>
													<td><p class="text-right">$14,564.00</p></td>
													<td><p class="text-left">VERACRUZ</p></td>
													<td><a type="button" class="btn btn-default btn-xs"
														data-toggle="modal" data-target="#modalComprobanteGral">
